...
var Model = (function () {
    ...
    function Model(uid, packet) {
        this.tags = [];
        this.uid = uid;
        this['vs'] = 127 /* Offline */; //All model's start as Offline
        if (packet !== undefined) {
                ...
                for (var key in payload) {
                    ...
                    if (key === "u" || key === "m" || key === "s") {
                        for (var key2 in payload[key]) {
                            ...
                            if (key === "m" && key2 === "flags") {
                                this.truepvt = payload[key][key2] & 8 /* TRUEPVT */ ? 1 : 0;
                                this.guests_muted = payload[key][key2] & 4096 /* GUESTMUTE */ ? 1 : 0;
                                this.basics_muted = payload[key][key2] & 8192 /* BASICMUTE */ ? 1 : 0;
                            }
                        }
                    }
                    else {
    ...
    Object.defineProperty(Packet.prototype, "pMessage", {
        ...
        get: function () {
            ...
            if (this._pMessage === undefined && typeof this.sMessage === 'object') {
                if (this.FCType === 50 /* CMESG */ || this.FCType === 3 /* PMESG */ || this.FCType === 6 /* TOKENINC */) {
...
function assert(condition, msg, packet) {
    if (!condition) {
        msg = "ASSERT: " + msg;
        if (packet !== undefined) {
            msg = msg + " : " + packet;
...
var Client = (function () {
    ...
    Client.prototype._packetReceived = function (packet) {
        ...
        if (packet.FCType === 20 /* SESSIONSTATE */) {
    ...
    Client.prototype.ensureEmoteParserIsLoaded = function (callback) {
        if (this.emoteParser !== undefined) {
            ...
            this.loadFromMFC("http://www.myfreecams.com/mfc2/lib/mfccore.js", function (err, obj) {
                if (err)
                    throw err;
    ...
    Client.prototype.ensureServerConfigIsLoaded = function (callback) {
        if (this.serverConfig !== undefined) {
            ...
            this.loadFromMFC("http://www.myfreecams.com/mfc2/data/serverconfig.js", function (err, obj) {
                if (err)
                    throw err;
    ...
    Client.prototype.TxCmd = function (nType, nTo, nArg1, nArg2, sMsg) {
        ...
        if (nType === 50 /* CMESG */ || nType === 3 /* PMESG */) {
            if (sMsg.match(/([\u0000-\u001f\u0022-\u0026\u0080-\uffff]+)/))
    ...
    Client.prototype.sendChat = function (id, msg, format) {
        ...
        if (format === true) {
            ...
            this.TxCmd(50 /* CMESG */, id, 0, 0, msg);
        }
    };
    ...
    Client.prototype.joinRoom = function (id) {
        ...
        this.TxCmd(51 /* JOINCHAN */, 0, id, 1 /* JOIN */);
    };
    ...
    Client.prototype.leaveRoom = function (id) {
        ...
        this.TxCmd(51 /* JOINCHAN */, 0, id, 2 /* PART */); //@TODO - Confirm that this works, it's not been tested
    };
    ...
    Client.prototype.login = function (username, password) {
        ...
        this.TxCmd(1 /* LOGIN */, 0, 20071025, 0, this.username + ":" + this.password);
    };
    return Client;
})();
