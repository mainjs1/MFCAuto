...
var Client = (function () {
    ...
    Client.prototype._packetReceived = function (packet) {
        ...
        if (packet.FCType === FCTYPE.ADDFRIEND && packet.sMessage !== undefined && (packet.sMessage).lv === 4) {
...
var Model = (function () {
    ...
    Object.defineProperty(Model.prototype, "bestSessionId", {
        ...
        get: function () {
            ...
            if (sessionIdToUse === 0 && this.knownSessions.size > 0) {
                ...
                sessionIdToUse = Array.from(this.knownSessions.keys)[this.knownSessions.size - 1];
            }
    ...
    Model.prototype.mergePacket = function (packet) {
        ...
        if (packet.FCType !== FCTYPE.TAGS && (packet.sMessage === undefined || packet.sMessage.sid === undefined)) {
        ...
        if (packet.FCType === FCTYPE.TAGS) {
            ...
            currentSessionId = packet.sMessage.sid;
        }
        ...
        switch (packet.FCType) {
            ...
            case FCTYPE.ADDFRIEND:
                ...
                assert(packet.sMessage === undefined || (packet.sMessage).lv === undefined || (packet.sMessage).lv === 4, "Merging a non-model? Non-models need some special casing that is not currently implemented.");
