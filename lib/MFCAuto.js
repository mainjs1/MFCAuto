...
var Client = (function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.ensureServerConfigIsLoaded().then(function () {
                ...
                _this.client = _this.net.connect(8100, chatServer + ".myfreecams.com", function () {
                    ...
                    _this.keepAlive = setInterval(function () { this.TxCmd(FCTYPE.NULL, 0, 0, 0, null); }.bind(_this), 120 * 1000);
                    resolve();
                });
            });
        });
    ...
    Client.prototype.connectAndWaitForModels = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.on("METRICS", modelListFinished.bind(_this));
            _this.connect(true);
        });
    };
...
var Model = (function () {
    ...
    Model.when = function (condition, onTrue, onFalseAfterTrue) {
        if (onFalseAfterTrue === void 0) { onFalseAfterTrue = null; }
